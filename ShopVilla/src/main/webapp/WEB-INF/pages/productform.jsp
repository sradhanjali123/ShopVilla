...
<label for="id" style="color:white;">Product Id</label>
<form:input path="id"  disabled="true"></form:input>
<form:errors path="id" cssStyle="color:red"></form:errors>
</div>

<div class="form-group">
<label for="name" style="color:white;" >Enter Product name</label>
<form:input path="name"></form:input>
<form:errors path="name" cssStyle="color:red"></form:errors>
</div>

<div class="form-group">
<label for="description" style="color:white;">Enter Description</label>
...
<div class="form-group">
<label for="manufacturer" style="color:white;">Product Manufacturer</label>
...
<div class="form-group">
<label for="price" style="color:white;">Product Price</label>
...
<div class="form-group">
<label for="unitInStock" style="color:white;">Unit In Stock</label>
